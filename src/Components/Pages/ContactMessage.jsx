...
const Search = () => {
  ...
  return (
    <>
      <div
        className={`bg-gray-100 flex flex-col items-center w-full h-[100%] py-[1.4rem] px-[1rem] transition-all duration-500 ease-in-out`}
      >
        <div className="w-full flex items-center pb-8">
          <span

            className="text-[2.1rem] text-red-400 font-bold cursor-pointer "
          >
            Mensajes
          </span>
        </div>
